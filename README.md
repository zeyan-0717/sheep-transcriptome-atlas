...
This repository provides the scripts used in the paper **A time-resolved multi-omics atlas of transcriptional regulation in response to high-altitude hypoxia across whole-body tissues**. The preprint is now on biorxiv: https://www.biorxiv.org/content/10.1101/2023.10.25.563964v1.
