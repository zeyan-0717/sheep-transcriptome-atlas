...
g2 <- c("S11","S12","S13","S14","S15", "S16","S17","S18","S19","S20") # 6 day
g3 <- c("S21","S22","S23","S24","S25", "S26","S27","S28","S29","S30") # 13 day
g4 <- c("S31","S32","S33","S34","S35", "S36","S37","S38","S39","S40") # 20 day
